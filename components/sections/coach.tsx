...
const milestones = [
  {
    ...
    body:
      "ขาเล็กเป็นไก่ ไหล่ไม่ผึ่ง อกไม่ผาย — ใส่เสื้อหลวมตลอดเพื่อกลบ เลี่ยงรูปถ่ายทุกใบ ผ่านกระจกในห้างก็เดินเร็วขึ้นนิดหนึ่ง. หุ่นแบบที่ผมฝันถึง — รู้สึกเหมือนเป็นของคนอื่น ไม่ใช่สิ่งที่ผมจะมีได้",
  },
  {
    year: "การเดินทาง",
